		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ZYG First application title",
									"targetURL": "#ui5schoolproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5schoolproject1-display": {
								"semanticObject": "ui5schoolproject1",
								"action": "display",
								"description": "ZYG First application description",
								"title": "ZYG First application title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5school.project1",
									"url": sap.ui.require.toUrl("ui5school/project1")
								}
							}
						}
					}
