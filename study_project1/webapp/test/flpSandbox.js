		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My title 1",
									"targetURL": "#FirstNameSpacestudyproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FirstNameSpacestudyproject1-display": {
								"semanticObject": "FirstNameSpacestudyproject1",
								"action": "display",
								"description": "First fiori application",
								"title": "My title 1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=FirstNameSpace.studyproject1",
									"url": sap.ui.require.toUrl("FirstNameSpace/studyproject1")
								}
							}
						}
					}
